...
<div class="page-content">
  ...
  <form class="forms-sample" id="myForm"  method="post" action="{{route('role.permission.store')}}"> 
          @csrf
            <div class="mb-3 form-group">
                <label for="role_id" class="form-label">Role name</label>
                <select class="role_name form-select form-group"  id="role_id" name="role_id" data-width="100%">
                    <option value=""></option> 
      ...
      @foreach ($group_names as $group )
       ...
       @endphp 
            ...
            <div class="col-9">
                ...
                <div class="form-check mb-2 form-group">
                    <input type="checkbox" name="permission[]" class="form-check-input" id="checkChecked{{$permission->id}}" 
                     value="{{$permission->id}}" >
